...
# Modifica esta sección para que coincida con la estructura de tu proyecto.
BASE_PATH = Path('/home/diego/Escritorio/AAL3')
QC_OUTPUT_DIR = BASE_PATH / 'qc_outputs_doctoral_v3.2_aal3_shrinkage_flexible_thresh_fix'
ROI_SIGNALS_DIR = BASE_PATH / 'ROISignals_AAL3_NiftiPreprocessedAllBatchesNorm'

# --- Archivos de Metadatos y Atlas ---
SUBJECT_METADATA_CSV_PATH = BASE_PATH / 'SubjectsData_Schaefer2018_400ROIs.csv'
...
AAL3_NIFTI_PATH = BASE_PATH / "AAL3v1.nii.gz"  # ¡IMPORTANTE! Asegúrate que está en el mismo espacio que Yeo (e.g., MNI 2mm)
